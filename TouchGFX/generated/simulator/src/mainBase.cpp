...
const uint8_t* video_test01_bin_start;
const uint8_t* video_test02_bin_start;
const uint8_t* video_test30_bin_start;
...
void setupVideoDecoder(touchgfx::HAL& hal)
{
    ...
    setupVideo(static_cast<touchgfx::HALSDL2&>(hal).localFileName(videoFileName, 400, "test01.bin"), &video_test01_bin_start, video_test01_bin_length);
    setupVideo(static_cast<touchgfx::HALSDL2&>(hal).localFileName(videoFileName, 400, "test02.bin"), &video_test02_bin_start, video_test02_bin_length);
    setupVideo(static_cast<touchgfx::HALSDL2&>(hal).localFileName(videoFileName, 400, "test30.bin"), &video_test30_bin_start, video_test30_bin_length);
}
